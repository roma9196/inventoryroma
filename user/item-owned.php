  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid">
  	  ...
  	  <ul class="nav navbar-nav">
  	    <li>
          <a href="dashboard.php"><span class="glyphicon glyphicon-dashboard"></span> Tablerod</a>
        </li>
  	     ...
  	     <li class="dropdown">
            <a class="dropdown-toggle" id="user-account" data-toggle="dropdown" href="#"></a>
    	      ...
    	      <ul class="dropdown-menu">
    	        <li><a href="#modal-changepass" id="change-password-button" data-toggle="modal">Cambia la contraseña</a></li>
    	        <li><a href="../data/user_logout.php">Cerrar sesión</a></li>
    	      </ul>
 	     </li>
 	   </ul>
 	 </div>
