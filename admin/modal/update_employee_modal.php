				...
				<!-- main form -->
					...
					<input type="hidden" id="update-eid">
					  <div class="form-group">
					    ...
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="update-fN" placeholder="Primer Name" autofocus>
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="update-mN" placeholder="Segundo Nombre">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="update-lN" placeholder="Introduzca segundo Apellido">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="update-office">Oficina:</label>
					    <div class="col-sm-9">
