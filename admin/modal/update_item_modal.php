				...
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itemName-update">Nombe de Articulo:</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="itemName-update" placeholder="Ingrese el nombre del artículo" autofocus>
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3" for="serialNumber-update">Serial.:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="serialNumber-update" placeholder="Ingrese Serial">
					    </div>
					  </div>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="modelNumber-update" placeholder="Ingrese modelo">
					    </div>
					  </div>
					
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="brand-update">Modelo:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="brand-update" placeholder="Ingrese modelo">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="amount-update" placeholder="Ingrese cantidad">
					    </div>
					  </div>		
				    ...
				    <div class="form-group">
					    <label class="control-label col-sm-3" for="empID-update">Personal:</label>
					    <div class="col-sm-9"> 
