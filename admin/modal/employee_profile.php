<div class="modal fade" id="modal-employee-profile">
	<div class="modal-dialog">
		...
		<!-- form -->
				<form class="form-horizontal" role="form">
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3">Posicion:</label>
				    <div class="col-sm-9">
				   ...
				   <div class="form-group">
				    <label class="control-label col-sm-3">Oficina:</label>
				    <div class="col-sm-9">
		...
		<!-- 		   <div class="form-group">
				    <label class="control-label col-sm-3">Tipo de Cta:</label>
				    <div class="col-sm-9">
 ...
 -->
				  <!-- <div class="form-group">
				    <label class="control-label col-sm-3">Trabaja Aqui:</label>
				    <div class="col-sm-9">
